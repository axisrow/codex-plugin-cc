...
- Leave the model unset unless the user explicitly asks for one. If they ask for `spark`, map it to `gpt-5.3-codex-spark`. If they ask for `sol`/`terra`/`luna`, map to `gpt-5.6-sol`/`gpt-5.6-terra`/`gpt-5.6-luna` respectively.
