...
// This is how long the turn may go silent (no turn/started, item/started, or
// item/completed notification) before it's considered dead — NOT a budget for
// the turn's total duration. A turn that keeps producing events can run far
// longer than this value without being killed; see HARD_WALL_CLOCK_CEILING_MS
// in lib/codex.mjs for the separate, much larger backstop on that case.
